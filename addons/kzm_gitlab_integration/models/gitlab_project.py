...
class GitlabProject(models.Model):
    ...
    position = fields.Selection([("test", "TEST"), ("pre_prod", "PRE PROD"), ("prod", "PROD")], string="Position", default="test")
        ...
        try:
            ...
            for project in projects:
                ...
                vals = {
                    ...
                    "project_name": project.attributes.get("path_with_namespace") or "",
